    ...
    function searchGo(key) {
      ...
      // 关键字搜索关联
		...
		<div class="indexnotice">
		  ...
		  <?php $tag_notice_list_class = new \Common\qscmstag\notice_listTag(array('列表名'=>'notice_list','显示数目'=>'10','分类'=>'1','排序'=>'addtime:desc','cache'=>'0','type'=>'run',));$notice_list = $tag_notice_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"网站首页","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$notice_list);?>
...
<div class="qsfooter link_gray6">
  <div class="txt font10">技术支持：湖南闲暇科技有限公司</div>
</div>
                ...
                <div class="bottom-bar-more-group">
                    ...
                    <div class="bar-more-cell">
                        <div id="hwslider-bottom" class="hwslider">
                            <ul>
                                <li>
                                    <a href="<?php echo url_rewrite('QS_jobslist');?>"><dl class="l1"><dt class="job for-event"></dt><dd class="font14">找工作</dd></dl></a>
                                    <a href="<?php echo url_rewrite('QS_resumelist');?>"><dl class="l1"><dt class="resume for-event"></dt><dd class="font14">找人才</dd></dl></a>
                                    <a href="<?php echo url_rewrite('QS_login');?>"><dl class="l1"><dt class="fabu for-event"></dt><dd class="font14">发布</dd></dl></a>
                                    <div class="clear"></div>
                                </li>
                                <li>
                                    <a href="<?php echo url_rewrite('QS_newslist');?>"><dl class="l1"><dt class="news for-event"></dt><dd class="font14">资讯</dd></dl></a>
                                    <?php if(!empty($apply['Mall'])): ?><a href="<?php echo url_rewrite('QS_mall_index');?>"><dl class="l1"><dt class="shop for-event"></dt><dd class="font14">商城</dd></dl></a><?php endif; ?>
                                    <?php if(!empty($apply['Jobfair'])): ?><a href="<?php echo url_rewrite('QS_jobfairlist');?>"><dl class="l1"><dt class="zhaoph for-event"></dt><dd class="font14">招聘会</dd></dl></a><?php endif; ?>
                                    <div class="clear"></div>
                                </li>
                            </ul>
                        </div>
