/* ============================================================
 * jquery.modal.search.js   Search page area js
 * ============================================================
 * Copyright Mr jobs.
 * ============================================================ */
!function($) {
	                ...
	                '<div class="modal_content pie_about">',
	                    ...
	                    '<div class="modal_body">',
	                    	'<div class="listed_group" id="J_listed_group">',
	                    		...
	                    		'<a href="javascript:;" class="right_text" id="J_listed_clear"> Emptied </a>',
	                    		'<div class="clear"></div>',
	                    	'</div>',
	                    ...
	                    '<div class="modal_footer">',
	                        '<div class="res_add_but">',
	                        	'<div class="butlist">',
	                            	'<div class="btn_blue J_hoverbut btn_100_38 J_btnyes"> Indeed   set </div>',
	                            '</div>',
	                            '<div class="butlist">',
	...
	//  Click to display the region category 
	$('#showSearchModal').die().live('click', function() {
		...
		var htmlCity = '';
		var isSubsite = eval(qscms.is_subsite); //  Whether it is sub-station 
    var subsiteLevelNum = eval(qscms.subsite_level);
		var subsiteLevel1 = true; //  Whether it is a sub-station 
    if (!isSubsite) { //  If not sub-station   First-class sub-station is always false
      subsiteLevel1 = false;
    } else {
      if (subsiteLevelNum > 1) { //  If it is sub-station ， Sub-station series is greater than 1  Then false
        subsiteLevel1 = false;
      }
    }
    var subsiteLevel1Width = 372;
		if (isSubsite) {
      if (isSpell) { //  pinyin 
        if (!subsiteLevel1) { //  Sub-station is two 
      ...
      if (subsiteLevel1) { //  First level station width 
    	...
    	if (recoverValue.length) {
		    if (multipleValue) {
		    	...
		    	if (subsiteLevel1) { //  A sub-station 
      ...
      //  Secondary area click 
        ...
        var checkedArray = new Array();
	      if (isSubsite && subsiteLevel1) { // 是分站并且是 A sub-station 
        ...
        $('#showSearchModal').text(titleArray.length ? titleArray.join('+') : ' please choose ');
        $('#showSearchModal').attr('title', titleArray.length ? titleArray.join('+') : ' please choose ');
        removeModal();
	    });
	});
