...
<div class="user_head_bg">
	...
	<div class="reg_com">
		<form class="J_passwordalert_group" id="registerForm" action="<?php echo U('members/register');?>" method="post" onkeydown="if(event.keyCode==13){return false;}">
			...
			<div class="rl J_focus">
				<div class="switch_title link_blue"><a href="<?php echo U('members/register',array('utype'=>2));?>">PERSONAL »</a></div>
				<div class="regtit">COMPANY</div>
				<div class="J_validate_group">
					<div class="td1">
						<input class="input_295_34" name="companyname" id="companyname" type="text" placeholder="company name" autocomplete="off" />
					</div>
					<div class="td2 J_showtip_box"></div>
				</div>
				<div class="J_validate_group">
					<div class="td1">
						<input class="input_295_34" name="contact" id="contact" type="text" placeholder="manager" autocomplete="off" />
					</div>
					<div class="td2 J_showtip_box"></div>
				</div>
				<div class="J_validate_group">
					<div class="td1">
						<div class="tel_td1">
							<input class="input_295_34" name="landline_tel_first" id="landline_tel_first" type="text" placeholder="prefix"/>
						</div>
						<div class="tel_td2">
							<input class="input_295_34" name="landline_tel_next" id="landline_tel_next" type="text" placeholder="office number"/>
						</div>
						<div class="tel_td3">
							<input class="input_295_34" name="landline_tel_last" id="landline_tel_last" type="text" placeholder="suffix"/>
						</div>
						<div class="clear"></div>
					</div>
					<div class="td2 J_showtip_box"></div>
				...
				<div class="J_validate_group">
					<div class="td1">
						<input class="input_295_34" name="telephone" id="telephone" type="text" placeholder="cellphone" autocomplete="off" />
					</div>
					<div class="td2 J_showtip_box"></div>
				</div>
				<div class="clear"></div>
				<div class="tips_td">Office phone or cellphone number should be set</div>
				<div class="regtit">ACCOUNT</div>
				<div class="J_validate_group">
					<div class="td1">
						<input class="input_295_34" name="username" id="username" type="text" placeholder="username" autocomplete="off" />
					</div>
					<div class="td2 J_showtip_box"></div>
				</div>
				<div class="J_validate_group">
					<div class="td1">
						<div class="reg-form-content">
							<input class="input_295_34 inputElem" name="email" id="email" type="text" placeholder="email address" autocomplete="off" />
						</div>
					</div>
					<div class="td2 J_showtip_box"></div>
				</div>
				...
				<div class="clear"></div>
				<div class="safety">
					<div class="slist t1">danger</div>
					<div class="slist t2">normal</div>
					<div class="slist t3">safe</div>
					<div class="clear"></div>
				</div>
				<div class="J_validate_group">
					<div class="td1">
				...
				Agree to <a href="javascript:;" id="reg_agreement"><?php echo C('qscms_site_name');?>'s Conditions of Use and Privacy Notice</a></label></div>
				<div class="btnbox">
					...
					<input name="" id="btnRegister" type="submit" value="Register" class="btn_reg J_hoverbut" />
				</div>
			</div>
			<!-- -->
			
			<div class="rr">
				<div class="tittxt">Already has <?php echo C('qscms_site_name');?> account:</div>
				
				<div class="logintxt"><a href="<?php echo U('members/login');?>" class=" J_hoverbut btn_blue btn_inline">Login</a></div>
				<div class="tittxt">LOGIN AS:</div>
	...
	<?php $tag_text_class = new \Common\qscmstag\textTag(array('列表名'=>'agreement','类型'=>'agreement','cache'=>'0','type'=>'run',));$agreement = $tag_text_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"","keywords"=>"","description"=>"","header_title"=>""),$agreement);?>
	<div class="footer_min" id="footer">
	<div class="links link_gray6">
	<a target="_blank" href="<?php echo url_rewrite('QS_index');?>">Home</a>   
	<?php $tag_explain_list_class = new \Common\qscmstag\explain_listTag(array('列表名'=>'list','cache'=>'0','type'=>'run',));$list = $tag_explain_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"","keywords"=>"","description"=>"","header_title"=>""),$list);?>
		...
		$('input').placeholder();
	  	...
	  	$("#reg_agreement").click(function(){
			var qsDialog = $(this).dialog({
        		title: "<?php echo C('qscms_site_name');?>'s Conditions of Use and Privacy Notice",
				backdrop: false
			});
