...
class ApplyController extends BackendController{
    ...
    public function setup(){
        ...
        if(!IS_POST){
            ...
            $mod == 'Home' && $this->error('Mr jobs人才系统核心模块已安装！');
            ...
            if($mod == 'Home'){
                $this->_show_process('安装应用失败！');
                $this->_show_process('Mr jobs人才系统核心模块已安装！','parent.install_failure();');
                return false;
            }
    ...
    public function unload(){
        ...
        if(!IS_POST){
            ...
            $mod == 'Home' && $this->error('Mr jobs人才系统核心模块无法卸载！');
            ...
            if($mod == 'Home'){
                $this->_show_process('卸载应用失败！');
                $this->_show_process('Mr jobs人才系统核心模块无法卸载！','parent.install_failure();');
                return false;
            }
            $apply = $apply[$mod];
