...
<div class="alltop_nav" id="nav">
	<div class="tnav">
  		<div class="tlogo"><a href="/qishi/"><img src="<?php if(C('qscms_logo_other')): echo attach(C('qscms_logo_other'),'resource'); else: ?>__HOMEPUBLIC__/images/logo_other.png<?php endif; ?>" border="0"/></a></div>
		<div class="tl">
