<?php
// +----------------------------------------------------------------------
// | Mr jobs [ WE CAN DO IT JUST THINK IT ]
// +----------------------------------------------------------------------
// | Copyright (c) 2009 http://www.jobs.kalichimall.com All rights reserved.
// +----------------------------------------------------------------------
// | Licensed ( http://www.apache.org/licenses/LICENSE-2.0 )
// +----------------------------------------------------------------------
// | Author: 
// +----------------------------------------------------------------------
// | ModelName: Mr jobs短信类
// +----------------------------------------------------------------------
class qscms_sms{
	protected $_error = 0;
	protected $setting = array();
	protected $_base_url = 'http://www.jobs.kalichimall.com/SMSsend.php?';//基础类短信请求地址
	protected $_notice_url = 'http://www.jobs.kalichimall.com/SMSsend.php?';//通知类短信请求地地址
	protected $_captcha_url = 'http://www.jobs.kalichimall.com/SMSsend.php?';//验证码类短信请求地址
	protected $_other_url = 'http://www.jobs.kalichimall.com/SMSsend.php?';//其它类短信请求地址
