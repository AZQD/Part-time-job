    ...
    $.extend($.validator, {
        ...
        prototype: {
            ...
            form: function()
            {
                ...
                this.showErrors();
                // Automatically gather and scroll to the first failed location 
                this.focusInvalid();
                return this.valid();
            },
            checkForm: function()
        ...
        methods: {
                    ...
                    $.ajax($.extend(true, {
                        ...
                        success: function(response)
                        {
                            ...
                            } else
                            {
								...
								// add ZhangYu    Increase the remote remote is the wrong style 
            ...
            // verification 是否大于( equal ) The value of the specified form  param  example ： ['#minDate',true]
            ...
            // verification 是否小于( equal ) The value of the specified form  param  example ： ['#maxDate',true]
            ...
            // Depends on the value of an element 
            dependTo: function(value, element, param)
            {
                var el = null;
                var val = true;
                var not = false; // Whether it is negated ，表示当值不 equal 指定的值时才 verification 
                if ($.isArray(param))
                {
            ...
            // Determines whether the specified regular expression is matched 
