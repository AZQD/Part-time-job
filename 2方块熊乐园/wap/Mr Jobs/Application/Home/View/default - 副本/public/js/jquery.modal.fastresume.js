...
/* ============================================================
 * jquery.modal.fastresume.js   Quickly create Resume Area Job Popup box 
 * ============================================================
 * Copyright Mr jobs.
 * ============================================================ */
!function($) {
	...
	$('#J_showmodal_city').live('click', function() {
		...
		var classifyModel = 0; //  Mark two or three categories 
		categoryValue > 2 ? classifyModel = 0 : classifyModel = 1;

		if (classifyModel) { //  Secondary classification 
			if (QS_city_parent) {
							...
							if (QS_city[combinationArray[1]]) {
								...
								if (eval(combinationArray[1]) == 0) {
									htmlCity += [
										'<li>',
											'<label>',
											' There are no subclasses under this category !</label>',
										'</li>'
									].join('');
								} else {
									htmlCity += [
	...
	//  Click to show job classification 
