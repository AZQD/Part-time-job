...
<meta name="author" content="Mr jobs"/>
<meta name="copyright" content="Mr jobs"/>
...
<div class="header_min" id="header">
	<div class="header_min_top">
		<div id="J_header" class="itopl font_gray6 link_gray6">
			<span class="link_yellow">Welcome to <?php echo C('qscms_site_name');?>!<a href="<?php echo U('home/members/login');?>">Login</a> or <a href="<?php echo U('home/members/register');?>">Register</a></span>
		</div>
		<div class="itopr font_gray9 link_gray6 substring"> <a href="/qishi/" class="home">Home</a>|
	<!-- 	<a href="<?php echo url_rewrite('QS_m');?>" class="m">手机访问</a>| -->
		<a href="<?php echo url_rewrite('QS_help');?>" class="help">Help</a>|<?php if(!empty($apply['Mall'])): ?><!--a href="<?php echo url_rewrite('QS_mall_index');?>" class="shop"><?php echo C("qscms_points_byname");?>商城</a--><?php endif; ?>
...
<div class="index_head">
	<div class="logobox">
		<a href="/qishi/"><img src="<?php if(C('qscms_logo_home')): echo attach(C('qscms_logo_home'),'resource'); else: ?>../public/images/logo.gif<?php endif; ?>" border="0"/></a>
	...
	<div class="sobox">
		<div class="inputbg">
			<div class="selecttype J_hoverbut">JOBS</div>
			<div class="selecttype_down">
				<div class="down_list J_hoverbut" data-type="QS_resumelist">RESUMES</div>
			</div>
			...
			<input id="top_search_btn" type="button" class="sobut J_hoverbut" value="Search" />
		</div>
...
<div class="index_nav_bg">
  <div class="index_nav">
    <ul class="link_gray6 nowrap">
    	<?php $tag_nav_class = new \Common\qscmstag\navTag(array('列表名'=>'nav','调用名称'=>'QS_top','数量'=>'10','cache'=>'0','type'=>'run',));$nav = $tag_nav_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$nav);?>
...
<div class="index_1">
	<div class="leftlogin">
		<div id="J_userWrap" class="shadowbg pie_about">
			<!--未登录 -->
	  		<div class="login">
				<div class="lontit">
					<span class="switch_txt active">LOGIN</span>
					<!--
				...
				<div class="type_box active">
					...
					<div class="j_mob_show">
							<div class="inputbox"><input name="username" type="text" value="" placeholder="Cellphone" class="input"/></div>
							<div class="inputbox"><input name="password" type="password" value="" placeholder="Password" class="input J_loginword"/></div>
							<div class="memorybox">
								<div class="memory"><label><input name="expire" class="J_expire" type="checkbox" value="0"/> Keep me signed in</label></div>
								<div class="getpwd link_yellow"><a href="<?php echo U('members/user_getpass');?>">Forget Password?</a></div>
								<div class="clear"></div>
							</div>
							<div class="inputbox">
								<input id="J_do_login_btn" type="button" value="Login"  class="index_login_btn"/>
							</div>
							<div class="apptit">
								<div class="t">
							...
							<div class="appsparent">
							    <div class="apps">
							    	<?php if(is_array($oauth_list)): $i = 0; $__LIST__ = $oauth_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$oauth): $mod = ($i % 2 );++$i; if($key != 'weixin'): ?><a class="ali <?php echo ($key); ?>" href="javascript:checkLoginState()" title="<?php echo ($oauth["name"]); ?>账号登录"></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
							<div class="btns">
						  		<a class="addbut a1" href="<?php echo U('members/register',array('utype'=>1));?>">New Job</a>
			  	              	<a class="addbut a2" href="<?php echo U('members/register',array('utype'=>2));?>">New Resume</a>
			  	            	<div class="clear"></div>
							</div>  
					</div>
				</div>
				...
				<div class="type_box">
					<div class="errbox J_errbox"></div>
					<div class="j_mob_show">
							<div class="inputbox"><input name="mobile" type="text" value="" placeholder="Cellphone" class="input"/></div>
							<div class="inputbox">
								<input name="verfy_code" type="text" value="" placeholder="Verify Code" class="J_loginword input code"/>
								<input id="getVerfyCode" type="button" value="Get The Code" class="index_login_btn_code"/>
							</div>
							<div class="memorybox">
								<div class="memory"><label><input name="expire_obile" class="J_expire" type="checkbox" value="0"/> Remember Me </label></div>
								<div class="getpwd link_yellow"><a href="<?php echo U('members/user_getpass');?>">Forget Password?</a></div>
								<div class="clear"></div>
							</div>
							<div class="inputbox">
								<input id="J_do_login_bymobile_btn" type="button" value="Login"  class="index_login_btn"/>
							</div>
							<div class="apptit">
							...
							<div class="btns">
						  		<a class="addbut a1" href="<?php echo U('company/add_jobs');?>">New Job</a>
			  	              	<a class="addbut a2" href="<?php echo U('personal/add_resume');?>">New Resume</a>
			  	            	<div class="clear"></div>
							</div>  
					</div>
				</div>
	...
	<div class="rben">
		<div class="wrapper">
			<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indexfocus','广告数量'=>'6','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
        ...
        <div class="emerb">
	        ...
	        <div class="more link_gray9"><a href="<?php echo url_rewrite('QS_jobslist',array('emergency'=>1));?>">more »</a></div>
            <div class="slide">
            	<?php $tag_jobs_list_class = new \Common\qscmstag\jobs_listTag(array('列表名'=>'emergency_jobs','紧急招聘'=>'1','显示数目'=>'6','cache'=>'0','type'=>'run',));$emergency_jobs = $tag_jobs_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$emergency_jobs);?>
		...
		<div class="ban_bot_ads">
			<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indexrecommend','广告数量'=>'4','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
		...
		<div class="notices">
			...
			<div class="notice_showtabs first">
				<ul class="link_gray6">
					<?php $tag_notice_list_class = new \Common\qscmstag\notice_listTag(array('列表名'=>'notice_list','显示数目'=>'3','分类'=>'1','cache'=>'0','type'=>'run',));$notice_list = $tag_notice_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$notice_list);?>
...
<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indextopimg','广告数量'=>'2','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
...
<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indexcentreimg','广告数量'=>'2','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
...
<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indexcenterrecommend','职位数量'=>'12','广告数量'=>'12','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
				...
				<div class="imgbox">
					<?php if(!empty($ad_info['company']['companyname'])): ?><div class="showinfo pie_about">
						...
						<?php if(!empty($ad_info['company']['jobs_count'])): ?><div class="count">
					          	<div class="v"><?php echo ($ad_info['company']['jobs_count']); ?> Jobs</div>
								<div class="more link_blue"><a target="_blank" href="<?php echo url_rewrite('QS_companyjobs',array('id'=>$ad_info['company']['id']));?>">all »</a></div>
								<div class="clear"></div>
					        </div><?php endif; ?>
					</div><?php endif; ?>
					<a href="<?php echo ($ad_info["href"]); ?>" target="_blank" title="<?php echo ($ad_info["title"]); ?>">
...
<div class="index_4">
	<div class="nleft">
	    <div class="ntit">
		  	<div class="lt">COMPANIES</div>
		  	<div class="rt no_change link_gray6"><a target="_blank" href="<?php echo url_rewrite('QS_helplist',array('id'=>19));?>">How to appear here?</a></div>
			<div class="clear"></div>
		</div>
	    <div class="vipjobs">
			<?php $tag_company_jobs_list_class = new \Common\qscmstag\company_jobs_listTag(array('列表名'=>'company_list','名企'=>'1','显示数目'=>'15','职位数量'=>'2','职位名长度'=>'5','cache'=>'0','type'=>'run',));$company_list = $tag_company_jobs_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$company_list);?>
			<?php if(is_array($company_list['list'])): $i = 0; $__LIST__ = $company_list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company): $mod = ($i % 2 );++$i;?><div class="comlist">
					...
					<div class="com link_gray6">
						...
						<div class="jobname_box">
							...
							<?php else: ?>
								NO COMPANY IS RECRUITING<?php endif; ?>
						</div>
					</div>	
					<div class="clear"></div>
				</div><?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="nright">
		<div class="ntit">
		  	<div class="lt">HOT JOBS</div>
		  	<div class="rt txt_right link_gray6"><a href="<?php echo url_rewrite('QS_jobslist',array('settr'=>7,'displayorder'=>'hot'));?>" target="_blank">more »</a></div>
			<div class="clear"></div>
		</div>
		<div class="hotjobs">
			<?php $tag_jobs_list_class = new \Common\qscmstag\jobs_listTag(array('列表名'=>'hot_jobs','日期范围'=>'7','排序'=>'hot','显示数目'=>'3','cache'=>'0','type'=>'run',));$hot_jobs = $tag_jobs_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$hot_jobs);?>
		...
		<div class="wrapper">
			<div class="slider-wrapper theme-default">
				<div id="slidersmall" class="ad300_175 nivoSlider">
					<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indexcentrefocus','广告数量'=>'5','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
...
<?php $tag_ad_class = new \Common\qscmstag\adTag(array('列表名'=>'ad','广告位名称'=>'QS_indexcenter','广告数量'=>'1','cache'=>'0','type'=>'run',));$ad = $tag_ad_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$ad);?>
...
<div class="index_5 J_change_parent">
	<div class="ntit">
	  	<div class="lt">LATEST JOBS</div>
		<div class="rt"><div class="refreshbtn J_change_batch" data-url="<?php echo U('AjaxCommon/jobs_list');?>">refresh</div></div>
		<div class="clear"></div>
	</div>
    <div class="jobs">
		<div class="ajax_loading"><div class="ajaxloadtxt"></div></div> 
		<?php $tag_company_jobs_list_class = new \Common\qscmstag\company_jobs_listTag(array('列表名'=>'new_jobs','职位数量'=>'3','排序'=>'rtime','显示数目'=>'20','cache'=>'0','type'=>'run',));$new_jobs = $tag_company_jobs_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$new_jobs);?>
...
<div class="J_change_parent">
	<div class="index_6">
		<div class="ntit">
		  	<div class="lt">RESUMES RECOMMENDED</div>
			<div class="rt"><div class="refreshbtn J_change_batch" data-url="<?php echo U('AjaxCommon/resume_list');?>">refresh</div></div>
			<div class="clear"></div>
		</div>
	</div>
...
<div class="index_7">
    ...
    <div class="nl">
	  	<div class="topnavbg">
			<div class="topnav">
				<?php $tag_classify_class = new \Common\qscmstag\classifyTag(array('列表名'=>'article_category','类型'=>'QS_article','id'=>'1','显示数目'=>'7','cache'=>'0','type'=>'run',));$article_category = $tag_classify_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$article_category);?>
	...
	<div class="nr">
		...
		<div class="news_showtabs show link_gray6">
			<?php $tag_news_list_class = new \Common\qscmstag\news_listTag(array('列表名'=>'hot_news','显示数目'=>'9','属性'=>'2','cache'=>'0','type'=>'run',));$hot_news = $tag_news_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$hot_news);?>
		...
		<div class="news_showtabs show link_gray6" style="display:none">
			<?php $tag_news_list_class = new \Common\qscmstag\news_listTag(array('列表名'=>'hot_news','显示数目'=>'9','属性'=>'3','cache'=>'0','type'=>'run',));$hot_news = $tag_news_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$hot_news);?>
			<?php if(is_array($hot_news['list'])): $i = 0; $__LIST__ = $hot_news['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><div class="tlist substring">
					<span class="<?php if($i <= 3): ?>sort1_3<?php else: ?>sort4_9<?php endif; ?>"><?php echo ($i); ?></span>
					<a href="<?php echo ($news["url"]); ?>" style="<?php if($news['tit_color']): ?>color:<?php echo ($news["tit_color"]); ?>;<?php endif; if($news['tit_b'] > 0): ?>font-weight:bold<?php endif; ?>" target="_blank"><?php echo ($news["title"]); ?></a>
				</div><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="index_8">
	<div class="ntit">
  	<div class="lt">FRIEND'S LINK</div>
	<div class="clear"></div>
</div>
<div class="links link_gray6">
	<?php $tag_link_class = new \Common\qscmstag\linkTag(array('列表名'=>'links','类型'=>'2','cache'=>'0','type'=>'run',));$links = $tag_link_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$links);?>
	...
	<div class="clear"></div>
	<!--文字链接 -->
	<?php $tag_link_class = new \Common\qscmstag\linkTag(array('列表名'=>'links','类型'=>'1','cache'=>'0','type'=>'run',));$links = $tag_link_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$links);?>
...
<div class="foot link_gray9">
	...
	<div class="txt">Hotline(09:00-19:00)</div>
</div>
  
  
  <div class="about">
  <div class="atit">ABOUT US</div>
  <?php $tag_explain_list_class = new \Common\qscmstag\explain_listTag(array('列表名'=>'list','显示数目'=>'4','cache'=>'0','type'=>'run',));$list = $tag_explain_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"Mr jobs","keywords"=>"Mr jobs","description"=>"Mr jobs","header_title"=>""),$list);?>
 ...
 <div class="about last">
  <div class="atit">HELP</div>
    <a target="_blank" href="<?php echo url_rewrite('QS_helplist',array('id'=>3));?>">Find a Job</a><br />
    <!--a target="_blank" href="<?php echo url_rewrite('QS_helplist',array('id'=>12));?>">招聘帮助</a><br /-->
    <a target="_blank" href="<?php echo U('Home/Members/user_getpass');?>">Forget Password</a><br />
    <a target="_blank" href="<?php echo url_rewrite('QS_suggest');?>">Suggestions</a>
  </div> 
  <div class="about">
	<div class="atit">PERSONAL</div>
	<a target="_blank" href="<?php echo url_rewrite('QS_jobs');?>">Find Jobs</a><br />
    <a target="_blank" href="<?php echo U('Home/Personal/resume_add');?>">My Resume</a><br />
    <a target="_blank" href="<?php echo url_rewrite('QS_jobslist',array('search_cont'=>'setmeal'));?>">Companies</a><br />
    <!--a target="_blank" href="<?php echo url_rewrite('QS_news');?>">职场资讯</a--> 
  </div>
  <div class="about">
	<div class="atit">COMPANY</div>
	<a target="_blank" href="<?php echo url_rewrite('QS_resume');?>">Find Resumes</a><br />
    <a target="_blank" href="<?php echo U('Home/Company/jobs_add');?>">Publish a New Job</a><br />
    <!--a target="_blank" href="<?php echo url_rewrite('QS_helplist',array('id'=>19));?>">招聘服务</a><br /-->
    <a target="_blank" href="<?php echo url_rewrite('QS_hrtools');?>">HR Tools</a> 
  </div>
...
Powered by <a href="http://www.jobs.kalichimall.com">Mr jobs</a> v<?php echo C('QSCMS_VERSION');?> <br />
...
<?php if($apply['Subsite']): ?><script id="J-sub-dialog-content" type="text/html">
		<div class="sub-dialog-group">
	        <div class="sdg-title">hi:</div>
	        <div class="sdg-split-20"></div>
	        <div class="sdg-h-tips">Please exchange to right city for more accurate resumes.</div>
	        <div class="sdg-split-30"></div>
	        <div class="sdg-h-line"></div>
	        <div class="sdg-split-20"></div>
	        <div class="sdg-master-group">
	            <?php if($subsite_org): ?><div class="sdg-txt-left">go</div>
		            <a href="<?php echo U('subsite/set',array('sid'=>$subsite_org['s_id']));?>" class="sdg-go"><?php echo ($subsite_org["s_sitename"]); ?></a>
		            <div class="sdg-txt-right">or change city</div>
	            <?php else: ?>
	            	<div class="sdg-txt-right">Exchange</div><?php endif; ?>
	            <div class="clear"></div>
	        </div>
	        <div class="sdg-split-20"></div>
	        <div class="sdg-sub-city-group">
	        	...
	        	<?php if(count($district) > 11): ?><a href="<?php echo U('subsite/index');?>" class="sdg-sub-city more">more cities »</a><?php endif; ?>
	            <div class="clear"></div>
	        </div>
	        <div class="sdg-split-16"></div>
	        <div class="sdg-bottom-tips">Any questions, please contact <?php if(C('qscms_top_tel')): echo C('qscms_top_tel'); else: echo C('qscms_bootom_tel'); endif; ?> </div>
