...
<div class="user_head">
  <div class="insidebox">
	<div class="logobox">
		<a href="/qishi/"><img src="<?php if(C('qscms_logo_user')): echo attach(C('qscms_logo_user'),'resource'); else: ?>__HOMEPUBLIC__/images/logo_user.png<?php endif; ?>" border="0"/></a>
	</div>
	<div class="nav link_white">
			<div class="list <?php if($company_nav == 'index'): ?>select<?php endif; ?>" onclick="window.location='<?php echo U('company/index');?>'"><a href="<?php echo U('company/index');?>">HOME</a></div>
			<div class="list <?php if($company_nav == 'jobs_list'): ?>select<?php endif; ?>" onclick="window.location='<?php echo U('company/jobs_list');?>'"><a href="<?php echo U('company/jobs_list');?>">JOBS</a></div>
			<div class="list <?php if($company_nav == 'jobs_apply'): ?>select<?php endif; ?>" onclick="window.location='<?php echo U('company/jobs_apply');?>'"><a href="<?php echo U('company/jobs_apply');?>">RESUMES</a></div>
			...
			<!--notempty name="apply['Jobfair']">
				<div class="list <?php if($company_nav == 'jobfair_list'): ?>select<?php endif; ?>" onclick="window.location='<?php echo U('company/jobfair_list');?>'"><a href="<?php echo U('company/jobfair_list');?>">招聘会</a></div>
			</notempty-->
			<div class="list <?php if($company_nav == 'com_info'): ?>select<?php endif; ?>" onclick="window.location='<?php echo U('company/com_info');?>'"><a href="<?php echo U('company/com_info');?>">ACCOUNT</a></div>
	        <div class="clear"></div>
	</div>
  </div>
</div>
<div class="index_main">
	<div class="ileft">
		<div class="hellow">
			<div class="tit"><span><?php echo ($am_pm); ?>, Dear HR </span><br />Today is <?php echo date('m-d-Y',time());?>&nbsp;&nbsp;&nbsp;星期<?php echo ($week[date('w')]); ?></div>
			<div class="td1">
			...
			<div class="btnbox link_gray6">
				<?php if($upper_limit != 1): ?><a href="<?php echo U('jobs_add');?>" class="btn1">NEW JOB</a>
				<?php else: ?>
					<a href="javascript:;" class="J_addJobsDig btn1">NEW JOB</a><?php endif; ?>
				<a href="javascript:;" class="btn2" id="refresh_jobs_all">UPDATE</a>
				<a target="_blank" href="<?php echo url_rewrite('QS_resumelist');?>" class="btn3">RESUMES</a>
			</div>
		</div>
		<!--
	...
	<div class="iright">
		<?php if(!$cominfo_flge): ?><div class="cominfotip">
				<div class="td1">
					<div class="t">You should Improve the basic information first</div>
					<div class="v">More details of your company will receive more apply</div> 
				</div>
				<div class="td2">
					<a href="<?php echo U('com_info');?>" class="btn_blue J_hoverbut btn_100_38 btn_border">Let's Go</a>
					<div class="J_companyinfo closs J_hoverbut" title="close"></div>
				</div>
				<div class="clear"></div>
			</div><?php endif; ?>
		<div class="i_main">
			<div class="comlogo">
				<div class="log link_blue">
		        	Last login:<?php if(($visitor['last_login_time']) == "0"): ?>Never Logined<?php else: echo date('m-d-Y H:i',$visitor['last_login_time']); endif; ?>&nbsp;&nbsp;&nbsp;<a href="<?php echo U('user_loginlog');?>">[LOGS]</a>
		        </div>
				<div class="td1">
					<div class="logobox">
				...
				<div class="td2">
	  		  		<div class="comname link_blue substring">
	  		  			<?php echo ($company_profile["companyname"]); ?> <a href="<?php echo U('com_info');?>">Edit</a>
	  		  		</div>
	  		  		...
	  		  		<?php else: ?>
	  		  		<div class="txt_line mt8 link_blue">Improve the basic information is the first step in recruitment. <a href="<?php echo U('com_info');?>">Let's Go</a></div><?php endif; ?>
			        ...
			        <div class="checkbox mt15 link_blue">
						<!--已经认证的叠加css  ok -->
						<?php if($company_profile['audit'] == 1): ?><a href="<?php echo U('com_auth');?>" class="btns btn1 ok">Verified</a>
						<?php else: ?>
							<a href="<?php echo U('com_auth');?>" class="btns btn1">Unverified</a><?php endif; ?>
						<?php if($visitor['mobile_audit']): ?>|<a href="<?php echo U('user_security');?>" class="btns btn2 ok">Cellphone-verified</a>
						<?php else: ?>
							|<a href="<?php echo U('user_security');?>" class="btns btn2">Cellphone-unverified</a><?php endif; ?>
						<?php if($visitor['email_audit']): ?>|<a href="<?php echo U('user_security');?>" class="btns btn3 ok">Email-verified</a>
						<?php else: ?>
							|<a href="<?php echo U('user_security');?>" class="btns btn3">Email-unverified</a><?php endif; ?>
						<!--notempty name="wx_status">
							<?php if($weixin_bind): ?>|<a href="<?php echo U('user_security');?>" class="btns btn4 ok">微信已认证</a>
							<?php else: ?>
			...
			<div class="data">
				<div class="titbg">
					...
					<div class="btns1">
						<div class="select_input input_140_30_div J_hoverinput J_dropdown J_listitme_parent">
							...
							<div class="dropdowbox12 J_dropdown_menu">
					            <div class="dropdow_inner12">
					                <ul class="nav_box">
					                	<li><a class="J_listitme statistics_select" href="javascript:;" data_k="settr" data_val="7">Last 7 Days</a></li>
					                	<li><a class="J_listitme statistics_select" href="javascript:;" data_k="settr" data_val="15">Last 15 Days</a></li>
					                	<li><a class="J_listitme statistics_select" href="javascript:;" data_k="settr" data_val="30">Last 1 Month</a></li>
					                </ul>
					            </div>
					        </div>
					...
					<div class="more link_blue"><a href="<?php echo U('company/statistics_visitor');?>">more »</a></div>
					<div class="clear"></div>
				</div>
				<div class="info statistics_wrap">No Data ...</div>
			</div>
			<div class="resumetit">
			  		<div class="lt">RECOMMENDED</div>
	        ...
	        <div class="resumelist">
	        	<?php if(!empty($resume_list)): if(is_array($resume_list)): $i = 0; $__LIST__ = $resume_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$resume): $mod = ($i % 2 );++$i;?><div class="li">
							<div class="bg J_hoverbut">
								...
								<div class="info">
									  ...
									  <div class="clear"></div>
								      <div class="txt"><?php echo ($resume['sex_cn']); ?> | <?php echo ($resume['age']); ?> | <?php echo ($resume['education_cn']); ?> | <?php echo ($resume['experience_cn']); ?> <br /><div class="substring"><?php echo ($resume['intention_jobs']); ?></div> </div>
								</div>
								<div class="clear"></div>
							</div>
				...
				<?php else: ?>
					<div class="res_empty link_blue">
						Sorry, no resumes. <a href="<?php echo U('jobs_add');?>">Publish a New Job Now?</a>
					</div><?php endif; ?>
				<div class="clear"></div>
			</div>
		</div>
...
<div class="clear"></div>
<div class="user_foot font_gray9" id="footer">© 2017 kaichimall.com</div>
<div class="floatmenu">
