				...
				<div class="mob j_mob_show">
					...
					<div class="type_box active">
				        ...
				        <div class="inputbox J_focus">
							<div class="imgbg"></div>
				        	<input type="text" class="input_login" name="username" id="username" placeholder="cellphone"/> 
				        </div>
						<div class="inputbox J_focus">
						    <div class="imgbg pwd"></div>
							<input type="password" class="input_login pwd J_loginword" name="password" id="password" placeholder="password"  />
						</div>
						<div class="txtbox link_gray6">
							<div class="td1"><label><input name="expire" class="J_expire" checked="checked" type="checkbox" value="1" /> Keep me signed in</label></div>				
							<div class="td2"><a href="<?php echo U('members/user_getpass');?>">Forget Password?</a></div>
						</div>
		 		        <div class="btnbox">
		 		        	<input class="btn_login J_hoverbut" type="button" id="J_dologin" value="Login" />
		 		        </div>
	        			<div class="qqbox">
						  	<div class="qtit">
							  		<div class="qtit_left">
										<?php if(!empty($oauth_list)): if(!(count($oauth_list) == 1 AND array_key_exists('weixin',$oauth_list))): ?>LOGIN AS<?php endif; endif; ?>
									</div>
					...
					<div class="type_box">
						...
						<div class="txtbox link_gray6">
							<div class="td1"><label><input name="expire_obile" class="J_expire" checked="checked" type="checkbox" value="1" /> Keep me signed in</label></div>					
							<div class="td2"><a href="<?php echo U('members/user_getpass');?>">Forget Password?</a></div>
						</div>
		 		        <div class="btnbox">
	        			...
	        			<div class="qqbox">
						  	<div class="qtit">
						  		<div class="qtit_left">LOGIN AS</div>
...
var global = {
  ...
  $(window).resize(function(){
	...
	<script src="../public/js/gt.js" type="text/javascript" language="javascript"></script>
	<script src="../public/js/facebook.js" type="text/javascript" language="javascript"></script>
</body>
</html>