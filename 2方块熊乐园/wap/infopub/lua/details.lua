...
local sql = "SELECT info_gg_users.nickname,info_gg_users.phone as uphone,info_gg_publist.details, info_gg_publist.phone,info_gg_publist.cid,info_gg_publist.pubtime FROM `info_gg_publist`, `info_gg_users` WHERE info_gg_publist.uid=info_gg_users.id and info_gg_publist.id = "..did
