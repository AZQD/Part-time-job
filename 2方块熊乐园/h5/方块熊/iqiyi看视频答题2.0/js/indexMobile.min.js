...
$(function() {
	...
	var n = randomNum(0, 5, 5),
		t = randomNum(0, 3, 3),
		a = [{ id: 0, questionTitleName: "本期节目里方块熊教谁做雪糕呢？", answerABC: ["佩奇", "乔治", "蛋蛋猪"], answerA: "佩奇", answerB: "乔治", answerC: "蛋蛋猪", titleImgUrl: "image/timu1.jpg", rightAnswer: "蛋蛋猪" }, 
	...
	$(".page3 .page3Content .questionTitle p .nums .num").html(o + 1),
		...
		$(".page3 .page3Content .answerBox .answer").on("touchstart",
			...
			if(i) {
				i = !1;
				var r = $(this).index();
				$(".page3 .page3Content .answer .answerContent").eq(r).html() == a[n[o]].rightAnswer ? (s += 20, $(".page3 .page3Content .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "image/three_right.png")) : $(".page3 .page3Content .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "image/three_wrong.png"),
					o++
			}
