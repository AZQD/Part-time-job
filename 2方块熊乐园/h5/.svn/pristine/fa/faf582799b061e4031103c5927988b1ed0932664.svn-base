	...
	$(".page3 .page3Content .questionTitle p .nums .num").html(o + 1),
		...
		$(".page3 .page3Content .answerBox .answer").on("touchstart",
			...
			if(i) {
				i = !1;
				var r = $(this).index();
				$(".page3 .page3Content .answer .answerContent").eq(r).html() == a[n[o]].rightAnswer ? (s += 33, $(".page3 .page3Content .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "http://h.boxbeartv.com/iqiyi/0703/image/three_right.png")) : $(".page3 .page3Content .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "http://h.boxbeartv.com/iqiyi/0703/image/three_wrong.png"),
					o++
			}
