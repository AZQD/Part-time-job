...
function randomNum(e, n, t) { for(var o = [], a = 0; t > a; a++) { o[a] = Math.floor(Math.random() * (n - e) + e); for(var i = 0; a > i; i++) o[a] == o[i] && a-- } return o } $(function() {
	...
	var n = randomNum(0, 3, 3),
		t = randomNum(0, 3, 3),
		o = [
			{ id: 0, questionTitleName: "本期节目里蛋蛋猪因为用功学习获得了什么奖励呢？", answerABC: ["趣威小手机", "趣威点读书", "趣威小汽车"], answerA: "趣威小手机", answerB: "趣威点读书", answerC: "趣威小汽车", titleImgUrl: "image/timu1.jpg", rightAnswer: "趣威小手机" },
			{ id: 1, questionTitleName: "以下哪个是报警电话呢？", answerABC: ["120", "110", "119"], answerA: "120", answerB: "110", answerC: "119", titleImgUrl: "image/timu2.jpg", rightAnswer: "110" },
			{ id: 4, questionTitleName: "本期节目里蛋蛋猪第一个电话打给谁了呢？", answerABC: ["月亮婆婆", "小兔子", "太阳公公"], answerA: "月亮婆婆", answerB: "小兔子", answerC: "太阳公公", titleImgUrl: "image/timu3.jpg", rightAnswer: "太阳公公" }
/*
