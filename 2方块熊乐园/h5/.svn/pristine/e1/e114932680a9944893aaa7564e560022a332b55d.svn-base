$('.sectionMobile .aboutVideo iframe').attr('src','http://open.iqiyi.com/developer/player_js/coopPlayerIndex.html?vid=24e0c2bf29bd80c75bf77e5f87255e89&tvId=714914300&accessToken=2.f22860a2479ad60d8da7697274de9346&appKey=3955c3425820435e86d0f4cdfe56f5e7&appId=1368&height=100%&width=100%');
var str = "";
	...
	$(".page3 .page3Content .questionTitle p .nums .num").html(o + 1),
		...
		$(".page3 .page3Content .answerBox .answer").on("touchstart",
			...
			if(i) {
				i = !1;
				var r = $(this).index();
				$(".page3 .page3Content .answer .answerContent").eq(r).html() == a[n[o]].rightAnswer ? (s += 33, $(".page3 .page3Content .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "image/three_right.png")) : $(".page3 .page3Content .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "image/three_wrong.png"),
					o++
			}
			...
			setTimeout(function() {
					if (o == 3) {
                        ...
                        if(s < 33){
							...
							$('.page4 .page4Content .page4Box .btnChooses .shareGame').hide();
                            $(".page4 .page4Content .page4Box .btnChooses .chouJiang").html("立即抽奖").hide().unbind("click").click(function(){
                                if(ajaxBtn == true){
                                    //console.log(data);
                                    if(ajaxResult){//中奖
