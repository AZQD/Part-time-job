$('.sectionPC .aboutVideo iframe').attr('src','http://open.iqiyi.com/developer/player_js/coopPlayerIndex.html?vid=d705f539b3e718d8b09f45cc9b65f7b6&tvId=656246600&accessToken=2.f22860a2479ad60d8da7697274de9346&appKey=3955c3425820435e86d0f4cdfe56f5e7&appId=1368&height=100%&width=100%');
var ajaxBtn = false;
var ajaxResult;
var ajaxKey;
...
function randomNum(e, n, t) { for(var o = [], a = 0; t > a; a++) { o[a] = Math.floor(Math.random() * (n - e) + e); for(var i = 0; a > i; i++) o[a] == o[i] && a-- } return o } $(function() {
	...
	var n = randomNum(0, 5, 5),
		t = randomNum(0, 3, 3),
		o = [
			{ id: 0, questionTitleName: "本期节目里方块熊教谁做雪糕呢？", answerABC: ["佩奇", "乔治", "蛋蛋猪"], answerA: "佩奇", answerB: "乔治", answerC: "蛋蛋猪", titleImgUrl: "image/timu1.jpg", rightAnswer: "蛋蛋猪" }, 
			{ id: 1, questionTitleName: "蛋蛋猪为什么要学做雪糕呢？", answerABC: ["他想送给好朋友", "他想开个雪糕店", "他想送给家人吃"], answerA: "他想送给好朋友", answerB: "他想开个雪糕店", answerC: "他想送给家人吃", titleImgUrl: "image/timu2.jpg", rightAnswer: "他想开个雪糕店" }, 
			{ id: 2, questionTitleName: "故事里方块熊用的魔力沙是？", answerABC: ["伊比沙", "培培乐", "趣威"], answerA: "伊比沙", answerB: "培培乐", answerC: "趣威", titleImgUrl: "image/timu3.jpg", rightAnswer: "伊比沙" }, 
			{ id: 3, questionTitleName: "蛋蛋猪找谁帮忙做雪糕呢？", answerABC: ["小丸子", "西瓜猴", "方块熊"], answerA: "小丸子", answerB: "西瓜猴", answerC: "方块熊", titleImgUrl: "image/timu4.jpg", rightAnswer: "方块熊" }, 
			{ id: 4, questionTitleName: "是谁想在方块熊乐园里开雪糕店呢？", answerABC: ["蛋蛋猪", "西瓜猴", "方块熊"], answerA: "蛋蛋猪", answerB: "西瓜猴", answerC: "方块熊", titleImgUrl: "image/timu5.jpg", rightAnswer: "蛋蛋猪" }
		],
		a = 0,
		i = !0,
		s = 0;
	$(".page3 .page3Content .questionTitle p .nums .num").html(a + 1), $(".page3 .page3Content .questionTitle p .questionTitleName").html(o[n[a]].questionTitleName), $(".page3 .page3Content .questionTitle img").attr("src", o[n[a]].titleImgUrl), $(".page3 .page3Content .answer .answerA").html(o[n[a]].answerABC[t[0]]), $(".page3 .page3Content .answer .answerB").html(o[n[a]].answerABC[t[1]]), $(".page3 .page3Content .answer .answerC").html(o[n[a]].answerABC[t[2]]), $(".page3 .page3Content .answerBox .answer").on("touchstart", function() {console.log($(this)); $(this).css({ background: "#FD6568"}) }).on("touchend", function() { $(this).css({ background: "#fff"}) }).click(function() {
		if(i) {
			i = !1;
			var r = $(this).index();
			$(".page3 .page3Content .answerBox2 .answer .answerContent").eq(r).html() == o[n[a]].rightAnswer ? (s += 20, $(".page3 .page3Content .answerBox2 .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "image/three_right.png")) : $(".page3 .page3Content .answerBox2 .answer .isTrue img").css("opacity", 0).eq(r).css("opacity", 1).attr("src", "image/three_wrong.png"), a++
		}
		setTimeout(function() { 5 == a && (e.unlockSwipes(), e.slideTo(2, 1e3, !1), e.lockSwipes(), $(".page4 .page4Content .page4Box .four_myScore").html(s)),
		...
		console.log(s);
			...
			if(s < 40){
				...
				$(".page4 .page4Content .page4Box .chouJiang").html("立即抽奖！").unbind("click").click(function(){
                    if(ajaxBtn == true){
                        //console.log(data);
                        if(ajaxResult){//中奖
		...
		5 > a && ($(".page3 .page3Content .questionTitle p .questionTitleName").html(o[n[a]].questionTitleName), $(".page3 .page3Content .questionTitle img").attr("src", o[n[a]].titleImgUrl), $(".page3 .page3Content .answer .answerA").html(o[n[a]].answerABC[t[0]]), $(".page3 .page3Content .answer .answerB").html(o[n[a]].answerABC[t[1]]), $(".page3 .page3Content .answer .answerC").html(o[n[a]].answerABC[t[2]]), $(".page3 .page3Content .answer .isTrue img").css("opacity", 0), $(".page3 .page3Content .questionTitle p .nums .num").html(a + 1)), i = !0 }, 1e3)
