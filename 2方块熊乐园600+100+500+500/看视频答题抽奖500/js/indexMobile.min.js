...
$(function() {
	...
	var n = randomNum(0, 5, 5),
		...
		a = [{
				id: 0,
				questionTitleName: "方块熊这次准备了几个惊喜？",
				answerABC: ["1个", "2个", "3个"],
				answerA: "1个",
				answerB: "2个",
				answerC: "3个",
				titleImgUrl: "image/1.jpg",
				rightAnswer: "2个"
			},
			{
				id: 1,
				questionTitleName: "方块熊的新朋友是？",
				answerABC: ["佩奇", "乔治", "蛋蛋猪"],
				answerA: "佩奇",
				answerB: "乔治",
				answerC: "蛋蛋猪",
				titleImgUrl: "image/2.jpg",
				rightAnswer: "蛋蛋猪"
			},
			{
				id: 2,
				questionTitleName: "方块熊今天做的是？",
				answerABC: ["糖果", "蛋糕", "米饭"],
				answerA: "糖果",
				answerB: "蛋糕",
				answerC: "米饭",
				titleImgUrl: "image/3.jpg",
				rightAnswer: "糖果"
			},
			{
				id: 3,
				questionTitleName: "蛋蛋猪是一只？",
				answerABC: ["小狗", "小猪", "小猫"],
				answerA: "小狗",
				answerB: "小猪",
				answerC: "小猫",
				titleImgUrl: "image/4.jpg",
				rightAnswer: "小猪"
			},
			{
				id: 4,
				questionTitleName: "片中使用的黏土是？",
				answerABC: ["方块熊", "培培乐", "趣威文化"],
				answerA: "方块熊",
				answerB: "培培乐",
				answerC: "趣威文化",
				titleImgUrl: "image/5.jpg",
				rightAnswer: "培培乐"
			}
		],
		o = 0,
                                ...
                                if(ajaxBtn == true){
                                    ...
                                    if(ajaxResult){//中奖
                                        ...
                                        $(".page4 .alertBoxSuccess .writeMsg").unbind("click").click(function(){//跳转到填写表单页面
											...
											console.log(2);
											document.getElementById("mobileIframe").contentDocument.getElementById("form_submit").style.color="red";
											setTimeout(function(){
												console.log($("#mobileIframe"));
												var win = document.getElementById('mobileIframe').contentWindow;
												console.log( win);
											}, 1000);
											$("#mobileIframe #form_submit").css("color", "red");
